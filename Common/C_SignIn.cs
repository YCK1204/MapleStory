...
public struct C_SignIn : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static C_SignIn GetRootAsC_SignIn(ByteBuffer _bb) { return GetRootAsC_SignIn(_bb, new C_SignIn()); }
  public static C_SignIn GetRootAsC_SignIn(ByteBuffer _bb, C_SignIn obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public C_SignIn __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<C_SignIn> CreateC_SignIn(FlatBufferBuilder builder,
      StringOffset user_idOffset = default(StringOffset),
      StringOffset passwordOffset = default(StringOffset)) {
    builder.StartTable(2);
    C_SignIn.AddPassword(builder, passwordOffset);
    C_SignIn.AddUserId(builder, user_idOffset);
    return C_SignIn.EndC_SignIn(builder);
  }

  public static void StartC_SignIn(FlatBufferBuilder builder) { builder.StartTable(2); }
  ...
  public static Offset<C_SignIn> EndC_SignIn(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<C_SignIn>(o);
  }
}


static public class C_SignInVerify
{
